import {
    Component, EventEmitter, ElementRef, ViewContainerRef,
...
export class Panel {
    ...
    constructor(elementRef:ElementRef, private viewContainerRef:ViewContainerRef, private appRef:ApplicationRef ) {
    ...
    close() {
        ...
        // this.viewContainerRef["_element"].componentView.ref.destroy();
        // this.viewContainerRef["_element"].componentView.destroy();
